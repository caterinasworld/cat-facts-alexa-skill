...
// The cat facts below come from https://www.factretriever.com/cat-facts
const catFacts = [
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput =
      'Welcome, you can say Hello, Help, or ask for a cool cat fact. Which would you like to try?';
